...
const Featured = ({slice}) => {
  ...
  return (
    <div className='max-w-360 w-full mx-auto mt-32.75 mb-62.5 px-26 relative'>
       <PrismicNextImage field={slice.primary.image} />
       <div className='absolute max-w-230 wi-full top-83.75 left-104 p-10.5 flex flex-col bg-white rounded-3xl shadow-2xl'>
